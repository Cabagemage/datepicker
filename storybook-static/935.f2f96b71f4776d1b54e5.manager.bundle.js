...
(self.webpackChunkdatepicker = self.webpackChunkdatepicker || []).push([
	[935],
	{
		15935: function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
			...
			(convert$1.rgb.hsl = function (rgb) {
				...
				(convert$1.hcg.rgb = function (hcg) {
					...
					return (
						(mg = (1 - c) * g), [255 * (c * pure[0] + mg), 255 * (c * pure[1] + mg), 255 * (c * pure[2] + mg)]
					);
				}),
			...
			var COLOR_SPACES = Object.values(ColorSpace),
				...
				useColorInput = function useColorInput(initialValue, onChange) {
					var _useState2 = _slicedToArray(
							(0, react__WEBPACK_IMPORTED_MODULE_26__.useState)(initialValue || ""),
							2
						),
						value = _useState2[0],
