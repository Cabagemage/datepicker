/*! For license information please see 51.9341f8237d0209e995b7.manager.bundle.js.LICENSE.txt */
(self.webpackChunkdatepicker = self.webpackChunkdatepicker || []).push([
	[51],
	{
		25051: function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
			"use strict";
											...
											if ("code" === token.type) {
												...
												if (
													...
													var lang = codeLang.content.replace(/\b#/g, "sharp").replace(/\b\+\+/g, "pp"),
														alias =
															"language-" + (lang = (/[a-z][\w-]*/i.exec(lang) || [""])[0].toLowerCase());
													codeBlock.alias
			...
			function createElement(_ref) {
				...
				if (TagName) {
					...
					if (useInlineStyles) {
						...
						props = _objectSpread({}, properties, { className: createClassNameString(properties.className) });
		...
		94953: function (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {
