/*! For license information please see 897.10170dc7512b47dec4f6.manager.bundle.js.LICENSE.txt */
"use strict";
						...
						FRAMEWORK = (function () {
							...
							function _animate(el, props, options, easing, complete, guaranteedNext) {
								...
								for (key in (animObj || ((animObj = { el: el, q: [] }), _animations.push(animObj)), props))
									from[key] =
										key === _strScrollLeft || key === _strScrollTop ? el[key] : FakejQuery(el).css(key);
								for (key in from)
							...
							return (
								(FakejQuery[LEXICON.p] = {
									on: function on(eventName, handler) {
										var el,
											eventNameLength = (eventName = (eventName || _strEmpty).match(_rnothtmlwhite) || [
												_strEmpty,
											])[LEXICON.l],
											i = 0;
										...
										if (
											...
											if (
												...
												var textareaCoverCSS = {},
													setContentGlueElementCSSfunction = function setContentGlueElementCSSfunction(
														horizontal
													) {
								...
								function setupStructureEvents() {
									var textareaUpdateIntervalID,
										...
										textareaKeyDownRestrictedKeyCodes = [
											112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 123, 33, 34, 37, 38, 39, 40, 16, 17,
											18, 19, 20, 144,
										],
