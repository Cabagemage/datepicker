...
var f,
	...
	R = function (e) {
		var r = e.locale,
			...
			N = (null == s ? void 0 : s.monthViewToday) ? s.monthViewToday : "datePicker__month-today";
		return o.jsxs(
			"div",
			n(
				{ className: S },
					...
					children: [
						...
						a.map(function (e) {
							var r,
								...
								x =
									!0 ===
									(null === (f = null == d ? void 0 : d.options) || void 0 === f
										? void 0
										: f.isPassedDateIncluded)
										? y({
												date: null !== (S = null == d ? void 0 : d.date) && void 0 !== S ? S : new Date(),
												type: "day",
												count: 1,
										  })
										: null !== (P = null == d ? void 0 : d.date) && void 0 !== P
										? P
										: new Date(),
								O = void 0 !== d && C(e, x),
								F = g.includes(v(e)),
								Y = new Date().toDateString() === e.toDateString();
							console.info(Y);
							var T,
								E = void 0 !== R && R.isDisabled,
								V = (void 0 !== h && h.includes(v(e))) || E,
								$ = void 0 !== p && p.includes(e.getDay()),
								I = void 0 !== R ? R.className : "";
							return (
								...
								o.jsx(
									...
									n(
										...
										},
										{
											children: o.jsx(
												"span",
												n({ className: _ }, { children: ((T = e), T.getDate().toString()) })
											),
										}
									),
									e.toString()
	...
	x = function (e) {
		var r = e.months,
			...
			d = (null == u ? void 0 : u.yearViewBody) ? u.yearViewBody : "datePicker-body__year",
	...
	M = function (e) {
		var r = e.years,
			...
			s = (null == c ? void 0 : c.body) ? c.body : "datePicker-body__decade",
	...
	N = e.forwardRef(function (t, a) {
		var i,
			...
			N = t.onDateChange,
			O = t.customizedDates,
			F = t.customizationClassNames,
			Y = t.selectedDates,
			T = t.date,
			E = t.selectedInterval,
			V = t.onMonthClick,
			$ = t.view,
			I = t.changeCalendarView,
			L = t.customHeaderRenderProp,
			U = t.customDecadeViewRenderProp,
			W = t.customMonthCellRenderProp,
			A = t.customMonthViewRenderProp,
			z = t.customYearViewRenderProp,
			B = t.customYearCellRenderProp,
			q = t.customDayCellRenderProp,
			H = t.footerElement,
			J = t.isVisible,
			X = void 0 === J || J,
			G = void 0 === f ? "en" : f,
			K = void 0 !== T ? T : void 0 !== Y && void 0 !== Y[0] ? Y[0] : new Date(),
			Q = (function () {
				if ("week" === _ && void 0 !== T) {
					var e = w(T),
						t = h(T);
				...
				return void 0 !== Y
					...
					? g(E.start, E.end)
					: (null == E ? void 0 : E.start) && null === (null == E ? void 0 : E.end)
					? [null == E ? void 0 : E.start]
					: [];
			})(),
			Z = S({ initialDate: K, year: K.getFullYear(), month: K.getMonth() }),
			ee = e.useState(Z),
			te = ee[0],
			ne = ee[1],
			re = e.useState(te[15].getMonth()),
			ae = re[0],
			oe = re[1],
			ie = e.useState(K),
			le = ie[0],
			...
			fe = (function (e, t) {
				...
				return n;
			})(b({ date: le, type: "year", count: 10 }), 11),
			pe = e.useState(K.getFullYear()),
			ye = pe[0],
			ve = pe[1],
			me = e.useState(null != E ? E : { start: null, end: null }),
			he = me[0],
			ge = me[1],
			De = (function (e) {
				for (
			...
			we = function (e) {
				ve(e.getFullYear());
				var t = new Date(e.getFullYear(), le.getMonth(), le.getDate());
				void 0 !== P && P(t);
			},
			be = function (e, t) {
				"add" === e &&
			...
			_e = function () {
				if ("month" === $) {
					var e = ae + 1,
						t = 11 === ae;
					m.includes(e) && oe(e), t && (be("add", 1), oe(0));
				}
				"year" === $ && be("add", 1), "decade" === $ && be("add", 10);
			},
			ke = function () {
				if ("month" === $) {
					var e = ae - 1;
					m.includes(e) && oe(e), 0 === ae && (be("subtract", 1), oe(11));
				}
				"year" === $ && be("subtract", 1), "decade" === $ && be("subtract", 10);
			},
			Se = se.map(function (e) {
				return v(new Date(e));
			}),
			Ce = function (e) {
				var t = v(e);
				"single" === _ &&
					...
					"partial" === _ &&
						(function (e) {
							...
							var n = se.map(function (e) {
								return new Date(e);
							});
							N({ value: r(r([], n, !0), [new Date(e)], !1) });
						})(e),
					"interval" === _ &&
						(function (e) {
							var t = se.includes(e);
							if (
								(he.start && he.end && t && (ge({ start: null, end: null }), de([])),
								he.start && he.end && !t && (ge({ start: e, end: null }), de([e])),
								null === he.start &&
									(ge(function (t) {
									...
									de([e]),
									N({ value: [e] })),
								null !== he.start && null === he.end)
							) {
								ge(function (t) {
									return n(n({}, t), { end: e });
								});
								var r = new Date(he.start) < e ? he.start : e,
									a = new Date(e) > he.start ? e : he.start,
			...
			je = e.useMemo(
				function () {
					var e = b({ date: le, count: 10, type: "year" });
					switch ($) {
						case "month":
							return "".concat(D({ month: te[7], locale: G }), " ").concat(le.getFullYear());
						case "year":
							return "".concat(le.getFullYear());
						case "decade":
							return "".concat(e.getFullYear(), " — ").concat(le.getFullYear());
						default:
							return "test";
					}
				},
			...
			Re = (null === (i = null == F ? void 0 : F.common) || void 0 === i ? void 0 : i.wrapper)
				? F.common.wrapper
				: "datePicker-wrapper",
			xe = (null === (l = null == F ? void 0 : F.common) || void 0 === l ? void 0 : l.header)
				? F.common.header
				: "datePicker-header",
			Me = (null === (c = null == F ? void 0 : F.common) || void 0 === c ? void 0 : c.arrowLeft)
				? F.common.arrowLeft
				: "datePicker__controller datePicker__controller_type_prev",
			Ne = (null === (u = null == F ? void 0 : F.common) || void 0 === u ? void 0 : u.arrowRight)
				? F.common.arrowRight
				: "datePicker__controller datePicker__controller_type_next",
			Oe = (null === (s = null == F ? void 0 : F.common) || void 0 === s ? void 0 : s.headerControls)
				? null == F
					? void 0
					: F.common.headerControls
				: "datePicker__controls",
			Fe = (null === (d = null == F ? void 0 : F.common) || void 0 === d ? void 0 : d.headerText)
				? null == F
					? void 0
					: F.common.headerText
		...
		return (
			e.useEffect(
				function () {
					var e = S({ initialDate: le, month: ae });
					ne(e);
				},
				[ae, le]
			),
								...
								children: [
									void 0 !== L
										? L({
												...
												toNextUnitNavAction: _e,
												toPrevUnitNavAction: ke,
												headerText: je,
										  })
										: o.jsxs(
												"div",
													...
													{ className: xe },
													{
														children: [
															o.jsx(
																"button",
																n(
																	{ className: "datePicker-header__toggler", onClick: I, type: "button" },
																	{ children: o.jsx("time", n({ className: Fe }, { children: je })) }
																)
															),
															o.jsxs(
																"div",
																n(
																	...
																	{
																		children: [
																			o.jsx("button", { className: Me, type: "button", onClick: ke }),
																			o.jsx("button", { className: Ne, type: "button", onClick: _e }),
																		],
																	}
																)
															),
									...
									void 0 !== A &&
										A({
											...
											disabledDates: C,
											minDate: k,
											customMonthClassNames: null == F ? void 0 : F.month,
											selectedDates: se,
											onSelectDay: Ce,
										}),
									"month" === $ &&
									...
									void 0 !== z &&
										z({ months: De, currentMonthIdx: ae, minDate: k, onMonthClick: Pe, defaultLocale: G }),
									"year" === $ &&
										void 0 === z &&
										o.jsx(x, {
											months: De,
											currentMonthIdx: ae,
											customYearClassNames: null == F ? void 0 : F.year,
											minDate: k,
											customMonthCellRenderProp: W,
											onMonthClick: Pe,
											defaultLocale: G,
										}),
									void 0 !== U && U({ minDate: k, onYearClick: we, years: fe, activeYear: ye }),
									"decade" === $ &&
										void 0 === U &&
										o.jsx(M, {
											activeYear: ye,
											...
											onYearClick: we,
											years: fe,
											customYearCellRenderProp: B,
											customDecadeClassNames: null == F ? void 0 : F.decade,
										}),
									H && H,
								],
							}
