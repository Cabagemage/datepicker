...
export declare const MonthView: ({ locale, month, currentMonth, selectedDates, onSelectDay, customizedDates, onHoverDay, customMonthClassNames, minDate, disabledDates, weekendDates, }: MonthViewProps) => JSX.Element;
