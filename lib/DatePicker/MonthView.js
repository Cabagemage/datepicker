...
var MonthView = function (_a) {
	var locale = _a.locale,
		...
		onSelectDay = _a.onSelectDay,
		customizedDates = _a.customizedDates,
		onHoverDay = _a.onHoverDay,
		customMonthClassNames = _a.customMonthClassNames,
		minDate = _a.minDate,
		disabledDates = _a.disabledDates,
		weekendDates = _a.weekendDates;
	var mappedBannedDates =
	...
	var defaultMonthDayCellBackgroundClassName = (
		customMonthClassNames === null || customMonthClassNames === void 0
			? void 0
	...
	var monthViewWeekDaysClassName = (
		...
		? customMonthClassNames.monthViewWeekDays
		: "datePicker-weekdays";
	var monthViewWeekDaysListItemClassName = (
		customMonthClassNames === null || customMonthClassNames === void 0
			? void 0
			...
			{ className: monthViewMonthBodyClassName },
			{
				children: [
						...
						__assign(
							{ className: monthViewWeekDaysClassName },
							{
								children: week.map(function (item, idx) {
									return (0,
									jsx_runtime_1.jsx)("li", __assign({ className: monthViewWeekDaysListItemClassName }, { children: (0, formatDayOfWeek_1.formatDayOfWeek)(item, locale) }), idx);
								}),
							}
						)
					),
					month.map(function (item) {
						...
						var customizedDate =
							customizedDates === null || customizedDates === void 0
								? void 0
								: customizedDates.find(function (customizedDate) {
										return (0, core_1.formatDate)(item) === (0, core_1.formatDate)(customizedDate.date);
								  });
						var endDate =
							((_c = minDate === null || minDate === void 0 ? void 0 : minDate.options) === null ||
							_c === void 0
								? void 0
								: _c.isPassedDateIncluded) === true
								? (0, core_1.add)({
										date:
											(_d = minDate === null || minDate === void 0 ? void 0 : minDate.date) !== null &&
											_d !== void 0
												? _d
												: new Date(),
										type: "day",
								...
								: (_e = minDate === null || minDate === void 0 ? void 0 : minDate.date) !== null &&
								  _e !== void 0
								? _e
								: new Date();
						var isDisabled =
							minDate !== undefined ? (0, core_1.isFirstDateEarlierThanSecondOne)(item, endDate) : false;
						...
						var isDateDisabled =
							(mappedBannedDates !== undefined && mappedBannedDates.includes((0, core_1.formatDate)(item))) ||
								...
								},
								{
									children: (0, jsx_runtime_1.jsx)(
										...
										__assign(
											...
											{ children: (0, core_1.getFormattedShortDayForMonthView)(item) }
										)
									),
								}
							),
