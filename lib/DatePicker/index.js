...
var DatePicker = function (_a) {
	...
	var _j = (0, react_1.useState)(defaultDate),
		currentDate = _j[0],
		setCurrentDate = _j[1];
	var _k = (0, react_1.useState)([defaultDate]),
	...
	var selectDayForPartial = (0, react_1.useCallback)(
		function (date) {
	...
	var headerViewTogglerText = (0, react_1.useMemo)(
		function () {
		...
		__assign(
			{ className: datePickerWrapperCn },
			{
				children: [
									...
									{ className: datePickerHeaderCn },
									{
										children: [
											(0, jsx_runtime_1.jsx)(
												"button",
												__assign(
													{ className: "datePicker-header__toggler", onClick: changeCalendarView },
													{
														children: (0, jsx_runtime_1.jsx)(
															"time",
															__assign(
																{ className: "datepicker-header__time" },
																{ children: headerViewTogglerText }
															)
														),
													}
												)
					...
					view === "month" &&
						(0, jsx_runtime_1.jsx)(MonthView_1.MonthView, {
							locale: defaultLocale,
							month: month,
							...
							customMonthClassNames:
								customizationClassNames === null || customizationClassNames === void 0
									? void 0
									: customizationClassNames.month,
							selectedDates: updatedSelectedDates,
							onSelectDay: selectDay,
							onHoverDay: hoverEvent,
						}),
					view === "year" &&
						(0, jsx_runtime_1.jsx)(YearView_1.default, {
							months: monthsOfYear,
							selectedDates: updatedSelectedDates,
							minDate: minDate,
					...
					view === "decade" &&
						(0, jsx_runtime_1.jsx)(DecadeView_1.default, {
							minDate: minDate,
