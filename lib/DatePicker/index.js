...
exports.DatePicker = (0, react_1.forwardRef)(function (_a, ref) {
	var _b, _c, _d, _e;
	var locale = _a.locale,
		_f = _a.mode,
		mode = _f === void 0 ? "single" : _f,
		minDate = _a.minDate,
		disabledDates = _a.disabledDates,
		onYearClick = _a.onYearClick,
		weekendDates = _a.weekendDates,
		onDateClick = _a.onDateClick,
		customizedDates = _a.customizedDates,
		customizationClassNames = _a.customizationClassNames,
		selectedDates = _a.selectedDates,
		date = _a.date,
		selectedInterval = _a.selectedInterval,
		onMonthClick = _a.onMonthClick,
		view = _a.view,
		changeCalendarView = _a.changeCalendarView,
		customHeaderRenderProp = _a.customHeaderRenderProp;
	var defaultLocale = locale === undefined ? "en" : locale;
	var defineDefaultSelectedDates = function () {
		if (mode === "week" && date !== undefined) {
			var monday = (0, core_1.getMonday)(date);
			var sunday = (0, core_1.getSunday)(date);
			var formattedDates = (0, core_1.getDatesInRange)(monday, sunday).map(function (item) {
		...
		if (
			(selectedInterval === null || selectedInterval === void 0 ? void 0 : selectedInterval.start) &&
			(selectedInterval === null || selectedInterval === void 0 ? void 0 : selectedInterval.end)
		) {
			return (0, core_1.getDatesInRange)(selectedInterval.start, selectedInterval.end);
		}
		if (
			(selectedInterval === null || selectedInterval === void 0 ? void 0 : selectedInterval.start) &&
			(selectedInterval === null || selectedInterval === void 0 ? void 0 : selectedInterval.end) === null
		) {
			return [selectedInterval === null || selectedInterval === void 0 ? void 0 : selectedInterval.start];
		} else {
			return [];
		}
	};
	var defineDefaultDate = function () {
		if (date !== undefined) {
			return date;
		}
	...
	var defaultDate = defineDefaultDate();
	var defaultSelectedDates = defineDefaultSelectedDates();
	var INITIAL_MONTH_DATES = (0, core_1.getMonthCalendarViewDates)({
		initialDate: defaultDate,
		year: defaultDate.getFullYear(),
		month: defaultDate.getMonth(),
	});
	var _g = (0, react_1.useState)(defaultDate.getMonth()),
		currentMonthIdx = _g[0],
		setCurrentMonthIdx = _g[1];
	var _h = (0, react_1.useState)(INITIAL_MONTH_DATES),
		month = _h[0],
		setMonth = _h[1];
	var _j = (0, react_1.useState)(defaultDate),
		currentDate = _j[0],
		setCurrentDate = _j[1];
	var _k = (0, react_1.useState)(defaultSelectedDates),
		updatedSelectedDates = _k[0],
		setUpdatedSelectedDates = _k[1];
	var decadeYears = (0, core_1.getYears)(
		(0, core_1.subtract)({ date: currentDate, type: "year", count: core_2.ONE_DECADE }),
		11
	);
	var _l = (0, react_1.useState)(
			selectedInterval !== null && selectedInterval !== void 0
				? selectedInterval
				: {
						start: null,
						end: null,
	...
	var mappedSelectedDatesToFormattedValue = updatedSelectedDates.map(function (item) {
	...
	var selectDayForPartial = function (date) {
		...
		onDateClick({
			value: __spreadArray(__spreadArray([], mappedSelectedDatesToRawDates, true), [new Date(date)], false),
		});
	};
	...
	var headerText = (0, react_1.useMemo)(
		function () {
			var previousDecadeStart = (0, core_1.subtract)({
				date: currentDate,
				count: core_2.ONE_DECADE,
				type: "year",
			});
			switch (view) {
				case "month":
					return ""
						.concat(
							(0, core_1.getFormattedMonthToLocale)({
	...
	var datePickerWrapperCn = (
		(_b =
			customizationClassNames === null || customizationClassNames === void 0
				? void 0
				: customizationClassNames.common) === null || _b === void 0
			? void 0
			: _b.wrapper
	)
		? customizationClassNames.common.wrapper
		: "datePicker-wrapper";
	var datePickerHeaderCn = (
		(_c =
			customizationClassNames === null || customizationClassNames === void 0
				? void 0
				: customizationClassNames.common) === null || _c === void 0
			? void 0
			: _c.header
	)
		? customizationClassNames.common.header
		: "datePicker-header";
	var datePickerArrowLeftCn = (
		(_d =
			customizationClassNames === null || customizationClassNames === void 0
				? void 0
				: customizationClassNames.common) === null || _d === void 0
			? void 0
			: _d.arrowLeft
	)
		? customizationClassNames.common.arrowLeft
		: "datePicker__controller datePicker__controller_type_prev";
	var datePickerArrowNextCn = (
		(_e =
			customizationClassNames === null || customizationClassNames === void 0
				? void 0
				: customizationClassNames.common) === null || _e === void 0
			? void 0
			: _e.arrowLeft
	)
		? customizationClassNames.common.arrowLeft
	...
	return (0,
	jsx_runtime_1.jsxs)("div", __assign({ className: datePickerWrapperCn, ref: ref }, { children: [customHeaderRenderProp !== undefined ? customHeaderRenderProp({ changeCalendarView: changeCalendarView, toNextUnitNavAction: toNextUnitNavAction, toPrevUnitNavAction: toPrevUnitNavAction, headerText: headerText }) : (0, jsx_runtime_1.jsxs)("div", __assign({ className: datePickerHeaderCn }, { children: [(0, jsx_runtime_1.jsx)("button", __assign({ className: "datePicker-header__toggler", onClick: changeCalendarView }, { children: (0, jsx_runtime_1.jsx)("time", __assign({ className: "datepicker-header__time" }, { children: headerText })) })), (0, jsx_runtime_1.jsxs)("div", __assign({ className: "datePicker__controls" }, { children: [(0, jsx_runtime_1.jsx)("button", { className: datePickerArrowLeftCn, type: "button", onClick: toPrevUnitNavAction }), (0, jsx_runtime_1.jsx)("button", { className: datePickerArrowNextCn, type: "button", onClick: toNextUnitNavAction })] }))] })), view === "month" && (0, jsx_runtime_1.jsx)(MonthView_1.MonthView, { locale: defaultLocale, month: month, customizedDates: customizedDates, currentMonth: currentMonthIdx, disabledDates: disabledDates, weekendDates: weekendDates, minDate: minDate, customMonthClassNames: customizationClassNames === null || customizationClassNames === void 0 ? void 0 : customizationClassNames.month, selectedDates: updatedSelectedDates, onSelectDay: selectDay, onHoverDay: hoverEvent }), view === "year" && (0, jsx_runtime_1.jsx)(YearView_1.default, { months: monthsOfYear, selectedDates: updatedSelectedDates, minDate: minDate, onMonthClick: clickMonth, defaultLocale: defaultLocale }), view === "decade" && (0, jsx_runtime_1.jsx)(DecadeView_1.default, { minDate: minDate, onYearClick: clickYear, years: decadeYears })] }));
});
