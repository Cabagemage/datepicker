...
exports.DatePicker = (0, react_1.forwardRef)(function (_a, ref) {
    var _b, _c, _d, _e;
    var locale = _a.locale, _f = _a.mode, mode = _f === void 0 ? "single" : _f, minDate = _a.minDate, disabledDates = _a.disabledDates, onYearClick = _a.onYearClick, weekendDates = _a.weekendDates, onDateClick = _a.onDateClick, customizedDates = _a.customizedDates, customizationClassNames = _a.customizationClassNames, selectedDates = _a.selectedDates, date = _a.date, selectedInterval = _a.selectedInterval, onMonthClick = _a.onMonthClick, view = _a.view, changeCalendarView = _a.changeCalendarView, customHeaderRenderProp = _a.customHeaderRenderProp;
    ...
    var defineDefaultSelectedDates = function () {
        ...
        if ((selectedInterval === null || selectedInterval === void 0 ? void 0 : selectedInterval.start) && (selectedInterval === null || selectedInterval === void 0 ? void 0 : selectedInterval.end)) {
            return (0, core_1.getDatesInRange)(selectedInterval.start, selectedInterval.end);
        }
        if ((selectedInterval === null || selectedInterval === void 0 ? void 0 : selectedInterval.start) && (selectedInterval === null || selectedInterval === void 0 ? void 0 : selectedInterval.end) === null) {
    ...
    var _g = (0, react_1.useState)(defaultDate.getMonth()), currentMonthIdx = _g[0], setCurrentMonthIdx = _g[1];
    var _h = (0, react_1.useState)(INITIAL_MONTH_DATES), month = _h[0], setMonth = _h[1];
    var _j = (0, react_1.useState)(defaultDate), currentDate = _j[0], setCurrentDate = _j[1];
    var _k = (0, react_1.useState)(defaultSelectedDates), updatedSelectedDates = _k[0], setUpdatedSelectedDates = _k[1];
    var decadeYears = (0, core_1.getYears)((0, core_1.subtract)({ date: currentDate, type: "year", count: core_2.ONE_DECADE }), 11);
    var _l = (0, react_1.useState)(selectedInterval !== null && selectedInterval !== void 0 ? selectedInterval : {
        start: null,
        end: null,
    ...
    var headerText = (0, react_1.useMemo)(function () {
