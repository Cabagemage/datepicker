...
var getMonthCalendarViewDates = function (_a) {
    ...
    var firstWeekOfMonth = (0, getFirstWeekOfMonth_1.getFirstWeekOfMonth)({ initialDate: initialDate, month: month, year: year });
    var lastWeekOfMonth = (0, getLastWeekOfMonth_1.getLastWeekOfMonth)({ initialDate: initialDate, month: month, year: year });
    ...
    var lastWeek = (0, getDatesInRange_1.getDatesInRange)(nextMondayOfLastWeekOfMonth, nextSundayOfLastWeekOfMonth);
    ...
    var monthCalendarViewDates = constants_1.MAX_DATES_LENGTH < excludeRepeatedElements.length
