...
var getFirstWeekOfMonth = function (_a) {
    var _b = _a.initialDate, initialDate = _b === void 0 ? new Date() : _b, month = _a.month, year = _a.year;
    var startDate = new Date(year !== null && year !== void 0 ? year : initialDate.getFullYear(), month !== null && month !== void 0 ? month : initialDate.getMonth(), 1);
    ...
    var nextMonthAfterPreviousMonthOrCurrentMonthMonday = (0, getMonday_1.getMonday)(new Date(startDate === null || startDate === void 0 ? void 0 : startDate.getFullYear(), startDate === null || startDate === void 0 ? void 0 : startDate.getMonth(), 7));
    // if monday equal to first date of month, then we should get last monday of previous month
    var finalStartMonday = mondayFromPreviousMonthOrCurrentMonth.toUTCString() ===
    ...
    var week = (0, getDatesInRange_1.getDatesInRange)(finalStartMonday, nextMonthAfterPreviousMonthOrCurrentMonthMonday);
    return week;
};
