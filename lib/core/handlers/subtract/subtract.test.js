...
describe("fn should return prevDate", function () {
    test("Should return prev week start", function () {
        ...
        for (var _i = 0, _a = [
            ...
            var test_1 = _a[_i];
            expect((0, formatDate_1.formatDate)((0, index_1.subtract)({ date: date, count: test_1.count, type: "day" }))).toBe(test_1.expect);
        }
    });
    test("Should return prev month start", function () {
        ...
        for (var _i = 0, _a = [
            ...
            var test_2 = _a[_i];
            expect((0, formatDate_1.formatDate)((0, index_1.subtract)({ date: mockDateObject, count: test_2.count, type: "month" }))).toBe(test_2.expect);
        }
    });
    test("Should return substracted years date", function () {
        ...
        for (var _i = 0, _a = [
            ...
            var test_3 = _a[_i];
            expect((0, formatDate_1.formatDate)((0, index_1.subtract)({ date: mockDateObject, count: test_3.count, type: "year" }))).toBe(test_3.expect);
        }
    });
    test("Should return prev week", function () {
        ...
        for (var _i = 0, _a = [
            ...
            var test_4 = _a[_i];
            expect((0, formatDate_1.formatDate)((0, index_1.subtract)({ date: mockDateObject, count: test_4.count, type: "week" }))).toBe(test_4.expect);
        }
    });
});
