...
describe("fn should return sunday", () => {
    test("should be sunday of passed week", () => {
        const result = new Date("Sun Dec 11 2022 00:00:00 GMT+0300 (Moscow Standard Time)")
        mockedWeek.forEach((item) => {
            const monday = getSunday(item)
